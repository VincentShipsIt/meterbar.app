...
- Replaced the unconfigurable floating split-view sidebar with a compact custom
  220pt sidebar shell, an 8pt radius, the same native sidebar Lists, and an
  explicit toolbar collapse button.
...
- Installed and ad-hoc signed `/Applications/MeterBar Dev.app`; deep signature
  verification passed.
- Captured the real active dashboard at
  `/tmp/meterbar-surface-sidebar-fix-v2.png`, confirming translucent cards and
  removal of the oversized sidebar pill.
