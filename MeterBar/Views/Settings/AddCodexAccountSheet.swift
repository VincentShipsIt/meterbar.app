...
/// Modal sheet for adding a Codex profile backed by its own CODEX_HOME.
/// Extracted verbatim from the SettingsView monolith; it is presented from the
/// Providers tab's Codex Accounts section.
